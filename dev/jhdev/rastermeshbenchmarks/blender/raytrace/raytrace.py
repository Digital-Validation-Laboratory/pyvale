'''
================================================================================
Example: Blender raytrace example
...
def main() -> None:
    ...
    pv_surf.save("./dev/jhdev/rastermeshbenchmarks/blender/raytrace/case21_m5_out.stl")
    ...
    # Import the STL file
    bpy.ops.wm.stl_import(filepath="./dev/jhdev/rastermeshbenchmarks/blender/raytrace/case21_m5_out.stl")
