...
// Initialize depth and image buffers
    ...
    void raster(int sub_samp,
        ...
        // std::cout << "iamge_buffer " << std::endl;
        // for (int k = 0; k < depth_buffer.size(); k++){
        //     std::cout  << depth_buffer[k] << " ";
        //     if (k % (buffer_height * sub_samp) == 0) std::cout << std::endl;
        // }
        // std::cout << std::endl;
    ...
    // std::vector<double> return_depth_buffer(){
        
    //     return depth_buffer;
    // }


    // std::vector<double> return_image_buffer(){

                
    //     // std::cout << "iamge_buffer " << std::endl;
    //     // for (int k = 0; k < image_buffer.size(); k++){
    //     //     std::cout  << image_buffer[k] << " ";
    //     //     if (k % (buffer_height * sub_samp) == 0) std::cout << std::endl;
    //     // }
    //     // std::cout << std::endl;
