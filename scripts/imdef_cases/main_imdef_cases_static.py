...
# Import custom packages from the packages folder
import packages.ansys_tools as at
...
def create_test_case(save_path,test_case,fe_data):
    print('')
    print('--------------------------------------------------------------------')
    ...
    test_path = save_path+'TestCase{}_'.format(test_case.test_num)+test_case.test_tag
...
create_test_case(save_path,test_case,fe_data)
